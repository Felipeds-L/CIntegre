...
export default function Cadastro() {
  ...
  return (
    <div className="flex h-screen">
      ...
      {/* lado do formulário */}
      <div className="w-1/2 h-full flex items-start justify-start bg-white p-16">
        <form 
          onSubmit={handleSubmit} 
          className="w-full max-w-md p-8 space-y-4"
        >
          <h1 className="text-2xl font-bold text-center text-black-600">Registre-se</h1>

          <div>
            <label htmlFor="nome" className="block font-medium mb-1">Nome da Instituição</label>
            <input
              id="nome"
              type="text"
              value={nome}
