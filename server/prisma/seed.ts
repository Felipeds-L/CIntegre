  ...
  const activities = await Promise.all([
    ...
    prisma.activity.create({
      data: {
        ...
        photos: ['https://example.com/horta1.jpg'],
        status: 'open',
        pontuation: 200,
        ong_id: ongs[0].id,
      },
    ...
    prisma.activity.create({
      data: {
        ...
        photos: ['https://example.com/vacinacao1.jpg'],
        status: 'closed',
        pontuation: 160,
        ong_id: ongs[3].id,
      },
    ...
    prisma.activity.create({
      data: {
        ...
        photos: ['https://example.com/agua1.jpg'],
        status: 'closed',
        pontuation: 120,
        ong_id: ongs[1].id,
      },
    ...
    prisma.activity.create({
      data: {
        ...
        photos: [
          'https://example.com/cultura1.jpg',
          'https://example.com/cultura2.jpg',
        ],
        status: 'open',
        pontuation: 140,
        ong_id: ongs[5].id,
    ...
    prisma.activity.create({
      data: {
        ...
        photos: ['https://example.com/artesanato1.jpg'],
        status: 'open',
        pontuation: 110,
        ong_id: ongs[5].id,
      },
    ...
    prisma.activity.create({
      data: {
        ...
        photos: ['https://example.com/direitos1.jpg'],
        status: 'open',
        pontuation: 130,
        ong_id: ongs[6].id,
      },
    ...
    prisma.activity.create({
      data: {
        ...
        photos: ['https://example.com/juridico1.jpg'],
        status: 'in_progress',
        pontuation: 170,
        ong_id: ongs[6].id,
      },
    ...
    prisma.activity.create({
      data: {
        ...
        photos: ['https://example.com/mapeamento1.jpg'],
        status: 'open',
        pontuation: 155,
        ong_id: ongs[7].id,
      },
    ...
    prisma.activity.create({
      data: {
        ...
        photos: [
          'https://example.com/cesta1.jpg',
          'https://example.com/cesta2.jpg',
        ],
        status: 'closed',
        pontuation: 175,
        ong_id: ongs[8].id,
    ...
    prisma.activity.create({
      data: {
        ...
        photos: ['https://example.com/cozinha1.jpg'],
        status: 'in_progress',
        pontuation: 165,
        ong_id: ongs[8].id,
      },
    ...
    prisma.activity.create({
      data: {
        ...
        end_date: new Date('2024-11-20'),
        volunteer_quantity: 20,
        photos: ['https://example.com/social1.jpg'],
        status: 'in_progress',
        pontuation: 185,
        ong_id: ongs[9].id,
      },
    ...
    prisma.activity.create({
      data: {
        ...
        photos: [
          'https://example.com/capacitacao1.jpg',
          'https://example.com/capacitacao2.jpg',
        ],
        status: 'open',
        pontuation: 200,
        ong_id: ongs[9].id,
    ...
    prisma.activity.create({
      data: {
        ...
        volunteer_quantity: 50,
        photos: ['https://example.com/feira1.jpg'],
        status: 'open',
        pontuation: 145,
        ong_id: ongs[3].id,
      },
    ...
    prisma.activity.create({
      data: {
        ...
        end_date: new Date('2024-10-20'),
        volunteer_quantity: 12,
        photos: ['https://example.com/digitalizacao1.jpg'],
        status: 'open',
        pontuation: 125,
        ong_id: ongs[4].id,
      },
    ...
    prisma.activity.create({
      data: {
        ...
        volunteer_quantity: 30,
        photos: [
          'https://example.com/patrimonio1.jpg',
          'https://example.com/patrimonio2.jpg',
        ],
        status: 'open',
        pontuation: 160,
        ong_id: ongs[5].id,
    ...
    prisma.activity.create({
      data: {
        ...
        volunteer_quantity: 25,
        photos: ['https://example.com/mentoria1.jpg'],
        status: 'in_progress',
        pontuation: 190,
        ong_id: ongs[2].id,
      },
