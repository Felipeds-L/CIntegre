...
describe('AddressController', () => {
  ...
  beforeEach(() => {
    addressServiceMock =
      new AddressService() as jest.Mocked<AddressService>;
    addressController = new AddressController();
    (addressController as any).addressService =
      addressServiceMock;
  ...
  it('Should create a address', async () => {
    ...
    expect(
      addressServiceMock.createAddress,
  ...
  it('Should return 200 if it can looking for a Address', async () => {
    ...
    addressServiceMock.getAddress.mockResolvedValue(
      mockAddress,
    );
  ...
  it('Should return 200 if all Addres are found', async () => {
    ...
    addressServiceMock.getAllAddresses.mockResolvedValue(
      mockAddress,
    );
  ...
  it('Should return 500 if it throws', async () => {
    addressServiceMock.getAllAddresses.mockRejectedValue(
  ...
  it('Should return 200 if it Address is updated', async () => {
    ...
    expect(
      addressServiceMock.updateAddress,
  ...
  it('Should return 200 if Address is deleted', async () => {
    ...
    expect(
      addressServiceMock.deleteAddress,
    ).toHaveBeenCalledWith(1);
  ...
  it('Should return 500 if delete throws', async () => {
    req.params = { id: '99' };
    addressServiceMock.deleteAddress.mockRejectedValue(
      new Error('Internal Error Service'),
    );
